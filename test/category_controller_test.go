...
func setupTestDB() *sql.DB {
	db, err := sql.Open("mysql", "root@top(losthost:3306)/belajar_golang_restful_api_test")
...
func TestCreateCategorySuccess(t *testing.T) {
	...
	request.Header.Add("Content-Type", "RAHASIA")
...
func TestUpdateCategorySuccess(t *testing.T) {
	...
	tx, _ := db.Begin()
	categoryRepository := category.NewCategoryRepository()
	category := categoryRepository.SaveCategory(context.Background(), tx, domain.Category{
		Name: "Gadget",
	})
	tx.Commit()
...
func TestListCategoriesSuccess(t *testing.T) {
	...
	tx, _ := db.Begin()
	categoryRepository := category.NewCategoryRepository()
	category1 := categoryRepository.SaveCategory(context.Background(), tx, domain.Category{
		Name: "Gadget",
	})
	category2 := categoryRepository.SaveCategory(context.Background(), tx, domain.Category{
		Name: "Computer",
	})
	tx.Commit()
